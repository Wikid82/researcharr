...
PLUGIN_NAME = "sickrage"


class Plugin(BasePlugin):
    name = PLUGIN_NAME
    category = "media"
    description = "SickRage integration (read/search)"
    docs_url = "https://sickrage.github.io/"
    ...
    def blueprint(self):
        bp = Blueprint("sickrage_plugin", __name__, url_prefix="/plugin/sickrage")
