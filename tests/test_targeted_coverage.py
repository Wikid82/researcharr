...
def test_container_reset():
    ...
    from researcharr.core.container import reset_container, get_container, register_singleton
...
def test_container_convenience_register_singleton():
    ...
    from researcharr.core.container import register_singleton, resolve, reset_container
...
def test_container_convenience_register_factory():
    ...
    from researcharr.core.container import register_factory, resolve, reset_container
...
def test_container_convenience_register_class():
    ...
    from researcharr.core.container import register_class, resolve, reset_container
...
def test_container_convenience_has_service():
    ...
    from researcharr.core.container import has_service, register_singleton, reset_container
...
def test_events_reset():
    ...
    from researcharr.core.events import reset_event_bus, get_event_bus, subscribe, Events
...
def test_events_convenience_subscribe():
    ...
    from researcharr.core.events import subscribe, publish_simple, Events, reset_event_bus
...
def test_events_convenience_subscribe_all():
    ...
    from researcharr.core.events import subscribe_all, publish_simple, Events, reset_event_bus
...
def test_events_convenience_publish():
    ...
    from researcharr.core.events import publish, subscribe, Event, Events, reset_event_bus
...
def test_events_convenience_publish_simple():
    ...
    from researcharr.core.events import publish_simple, subscribe, Events, reset_event_bus
...
def test_backups_impl_error_handling():
    ...
    from researcharr.backups_impl import validate_backup_file, get_backup_size
...
def test_container_singleton_persistence():
    ...
    from researcharr.core.container import reset_container, register_class, resolve
...
def test_event_convenience_subscribe():
    """Test convenience subscribe function."""
    from researcharr.core.events import subscribe, reset_event_bus, publish_simple
...
def test_event_convenience_subscribe_all():
    """Test convenience subscribe_all function."""
    from researcharr.core.events import subscribe_all, reset_event_bus, publish_simple
...
def test_event_convenience_publish():
    """Test convenience publish function."""
    from researcharr.core.events import publish, Event, reset_event_bus, get_event_bus
...
def test_event_unsubscribe_all():
    ...
    from researcharr.core.events import reset_event_bus, get_event_bus, Event
...
def test_run_job_exception_in_globals_get():
    ...
    with patch.object(run, "__dict__", {"get": lambda *a: (_ for _ in ()).throw(Exception("globals error"))}):
        try:
            run.run_job()
        except Exception:
            pass
