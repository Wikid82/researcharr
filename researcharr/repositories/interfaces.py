...
class IGlobalSettingsRepository(Protocol):
    ...
    def get_by_key(self, key: str) -> object: ...  # Generic setting retrieval
    def set(self, key: str, value: object) -> None: ...  # Generic setting update
...
class IManagedAppRepository(Protocol):
    ...
    def get_enabled(self) -> Sequence[ManagedApp]: ...  # Alias for get_active_apps
...
class IProcessingLogRepository(Protocol):
    ...
    def get_recent(
        self, limit: int = 100
    ) -> Sequence[ProcessingLog]: ...  # Get recent logs across all apps
